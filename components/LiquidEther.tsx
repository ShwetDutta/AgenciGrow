...
`;
    ...
    class Advection extends ShaderPass {
      ...
      override update() {
        // Just call parent update
        super.update();
      }
      customUpdate({ dt, isBounce, BFECC }: any) {
        if (!this.line) return;
    ...
    class ExternalForce extends ShaderPass {
      ...
      constructor(simProps: any) {
        ...
        this.customInit(simProps);
      }
      customInit(simProps: any) {
        super.init();
    ...
    class Viscous extends ShaderPass {
      ...
      customUpdate({ viscous, iterations, dt }: any) {
        let fbo_in, fbo_out;
    ...
    class Simulation {
      ...
      update() {
        ...
        this.advection.customUpdate({
          dt: this.options.dt,
          isBounce: this.options.isBounce,
          BFECC: this.options.BFECC
        });
        this.externalForce.customUpdate({
          cursor_size: this.options.cursor_size,
        ...
        if (this.options.isViscous) {
          vel = this.viscous.customUpdate({
            viscous: this.options.viscous,
            iterations: this.options.iterations_viscous,
            dt: this.options.dt
          });
        }
        this.divergence.customUpdate({ vel });
        const pressure = this.poisson.customUpdate({
          iterations: this.options.iterations_poisson
        });
        this.pressure.customUpdate({ vel, pressure });
      }
    }
