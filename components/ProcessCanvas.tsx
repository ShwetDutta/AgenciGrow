 ...
 *
 * Houses:
 * 1. What We Believe (Chapter 02)
 * 2. Process / How We Work (Chapter 03 with Steps 01, 02, and 03)
 *
...
const ProcessCanvas: React.FC = () => {
  return (
    ...
    >
      <main className="flex-grow flex flex-col w-full px-5 sm:px-10 lg:px-14 pt-8 sm:pt-10">
